...
public class Util extends Base {
	...
	/**
	 * In this Util class, we write our re-usable methods. 
	 * Any methods that would be used more than once, will be stored here in a static methods
	 */
	
	
	//@return, this method returns date and time as a string.
